								...
								<form id="Email" name="Email" action="email_pdf.php?{$Session}#{$invoiceID}" method="post">
									...
									<table width="100%" border="0" cellpadding="2" cellspacing="0">
										...
										<tr>
											...
											<td class="dbTxt" valign="top" align="left" width="65%"><textarea title="{$Email_Text}" class="form_textarea" name="CompanyPdfAttachmentText" rows="10" cols="20">{$COMPANY_PDF_ATTACHMENT_TEXT}</textarea> 
											</td>
										</tr>
										<tr>
											<td>&nbsp;
