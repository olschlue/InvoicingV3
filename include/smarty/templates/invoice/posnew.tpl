	...
	{*			<tr>
		...
		<tr>
			...
			<tr>
				...
				{if $invoiceID}
					[&nbsp;<a title="{$BackMsg} - {$Invoice} - {$Edit}" class="ninfolink" href="edit.php?myID={$myID}&amp;page={$page}&amp;invoiceID={$invoiceID}&amp;infoID={$infoID}&amp;messageID={$messageID}&amp;InvoiceDate={$InvoiceDate}&amp;MethodOfPayment={$MethodOfPayment}&amp;MethodOfPaymentDate={$MethodOfPaymentDate}&amp;Note={$Note}&amp;Order={$Order}&amp;Sort={$Sort}&amp;tmpID=1{$Searchstring}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
				{else}
					[&nbsp;<a title="{$BackMsg} - {$Invoice} - {$New}" class="ninfolink" href="new.php?myID={$myID}&amp;page={$page}&amp;infoID={$infoID}&amp;messageID={$messageID}&amp;InvoiceDate={$InvoiceDate}&amp;MethodOfPayment={$MethodOfPayment}&amp;MethodOfPaymentDate={$MethodOfPaymentDate}&amp;Note={$Note}&amp;Order={$Order}&amp;Sort={$Sort}&tmpID=1&amp;{$Session}">{$BackMsg}</a>&nbsp;]
				{/if}
				</td>
				</tr>
				<tr>
