...
<tr><td align="center" colspan="9"><h2>{$Invoice} - {$SearchResult}</h2></td></tr>
<tr><td align="center" colspan="9">{$DateMsg} {$DateFrom} {$DateFrom1} {$DateTill} {$DateTill1}</td></tr>
<tr><td>&nbsp;</td></tr>
...
{if $invoice.CANCELED neq 1}
	...
	{if $smarty.session.Username and ( $smarty.session.Username eq $Root or $smarty.session.Username eq $invoice.CREATEDBY)}
		{if $invoice.PAID eq '2'}
			<td valign="top" align="center" width="50"><a href="edit.php?invoiceID={$invoice.INVOICEID}&amp;infoID=9&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/edit.png" title="{$Editentry}" alt="{$Editentry}" /></a></td>
...
{if $smarty.session.Username and ( $smarty.session.Username eq $Root )}
	...
	<tr><td valign="top" align="right" colspan="5"><b>{$Invoice_Amount} {$Searchresult} {$Invoice_Currency}</b>:</td><td valign="top" align="right" colspan="4"><b>{$TOTAL_AMOUNT|number_format}</b></td></tr>
{/if}
<tr><td>&nbsp;</td></tr>
