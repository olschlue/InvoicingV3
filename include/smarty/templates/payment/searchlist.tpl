...
<tr><td align="center" colspan="6"><h2>{$Payment} - {$Searchresult}</h2></td></tr>
<tr><td align="center" colspan="6">{$DateMsg} {$DateFrom} {$DateFrom_1} {$DateTill} {$DateTill_1}</td></tr>
<tr><td>&nbsp;</td></tr>
...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=PAYMENTID&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Payment_No} ASC" alt="{$SortMsg} {$Payment_No} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=PAYMENTID&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Payment_No} DESC" alt="{$SortMsg} {$Payment_No} DESC" /></a>
</td>
...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=P.PAYMENT_DATE&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$DateMsg} ASC" alt="{$SortMsg} {$DateMsg} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=P.PAYMENT_DATE&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$DateMsg} DESC" alt="{$SortMsg} {$DateMsg} DESC" /></a>
</td>
<td nowrap="nowrap" align="right">{$Payment_Sum} {$Payment_Currency}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=SUM_PAID&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Payment_Sum} ASC" alt="{$SortMsg} {$Payment_Sum} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=SUM_PAID&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Payment_Sum} DESC" alt="{$SortMsg} {$Payment_Sum} DESC" /></a>
</td>
<td nowrap="nowrap" align="left">{$Method_Of_Payment}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=METHOD_OF_PAY&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Method_Of_Payment} ASC" alt="{$SortMsg} {$Method_Of_Payment} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=METHOD_OF_PAY&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Method_Of_Payment} DESC" alt="{$SortMsg} {$Method_Of_Payment} DESC" /></a>
</td>
...
{foreach from=$PaymentData item=payment}
	...
	<td valign="top" align="left"><a name="{$payment.PAYMENTID}" title="{$AllInformation} {$Payment_No} {$payment.PAYMENTID}" class="ninfolink" href="info.php?myID={$payment.MYID}&amp;paymentID={$payment.PAYMENTID}&amp;infoID=9&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}">
...
{if $smarty.session.Username and ( $smarty.session.Username eq $Root )}
	...
	<tr><td valign="top" align="right" colspan="5">{$Payment_Sum} - {$Searchresult}  {$Payment_Currency}:</td><td valign="top" align="right">{$TOTAL_SEARCHRESULT|number_format}</td></tr>
