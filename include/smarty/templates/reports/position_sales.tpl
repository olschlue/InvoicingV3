...
<tr>
	...
	[&nbsp;<a title="{$PrintMsg} - {$SearchResult} - {$DateFrom} {$Date_Till} {$DateTill}" class="ninfolink" href="pdf/print_pdf.php?DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Type=Position_Sales&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}" target="_blank">{$PrintMsg}</a>&nbsp;]
	</td>
</tr>
...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=POS_PRICE&amp;Sort=ASC&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$PositionPrice} ASC" alt="{$SortMsg} {$PositionPrice} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=POS_PRICE&amp;Sort=DESC&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$PositionPrice} DESC" alt="{$SortMsg} {$PositionPrice} DESC" /></a>
</td>
<td nowrap="nowrap" align="right">{$PositionAmount} {$Currency}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=V.POS_QUANTITY*V.POS_PRICE&amp;Sort=ASC&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$PositionAmount} ASC" alt="{$SortMsg} {$PositionAmount} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=V.POS_QUANTITY*V.POS_PRICE&amp;Sort=DESC&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$PositionAmount} DESC" alt="{$SortMsg} {$PositionAmount} DESC" /></a>
</td>
...
{* {foreach from=$Positions item=position}
	...
	<td valign="top" align="right">{$position.POS_QUANTITY*$position.POS_PRICE|number_format}</td>
	<td></td>
	</tr>
{foreachelse}
...
{section name="i" loop=$Positions}
	<tr class="{cycle values="grayTD,wTD"}">
	<td valign="top" align="left"><a name="{$Positions[i].POSITIONID}" title="{$AllInformation} {$PositionName} - {$Positions[i].POS_NAME}" class="ninfolink" href="../position/info.php?posID={$Positions[i].POSITIONID}&amp;infoID=30&amp;{$Session}" target="_blank">{$Positions[i].POS_NAME}</a></td>
	<td valign="top" align="left">{$Positions[i].POS_DESC|nl2br}</td>
	<td valign="top" align="right">{$Positions[i].POS_QUANTITY}</td>
	<td valign="top" align="right">{$Positions[i].POS_PRICE|number_format}</td>
	<td valign="top" align="right">{$Positions[i].POS_QUANTITY*$Positions[i].POS_PRICE|number_format}</td>
	<td></td>
	</tr>
{sectionelse}
	<tr><td align="center" colspan="6" class="redtxt">{$NoEntry}</td></tr>
...
<tr><td>&nbsp;</td></tr>
<tr><td valign="top" align="right" colspan="5">{$PositionAmount} - {$PageMsg} {$Invoice_Currency}:</td><td valign="top" align="right">{$TOTAL_PAGE|number_format}</td></tr>
<tr><td valign="top" align="right" colspan="5"><b>{$PositionAmount} {$Searchresult} {$Invoice_Currency}</b>:</td><td valign="top" align="right"><b>{$TOTAL_AMOUNT|number_format}</b></td></tr>
<tr><td>&nbsp;</td></tr>
