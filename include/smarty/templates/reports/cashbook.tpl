...
<tr>
	...
	[&nbsp;<a title="{$PrintMsg} - {$Cashbook} - {$DateFrom} {$Date_Till} {$DateTill}" class="ninfolink" href="pdf/print_pdf.php?DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Type=Cashbook&amp;Canceled={$Canceled}&amp;MaxRows={$MaxRows}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}" target="_blank">{$PrintMsg}</a>&nbsp;]
	</td>
</tr>
<tr><td align="center" colspan="7"><h2>{$Reports} - {$Cashbook}</h2></td></tr>
...
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=CASHBOOKID&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Cashbook_No} ASC" alt="{$SortMsg} {$Cashbook_No} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=CASHBOOKID&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Cashbook_No} DESC" alt="{$SortMsg} {$Cashbook_No} DESC" /></a>
</td>
<td nowrap="nowrap" align="right">{$Takings} {$Cashbook_Currency}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=TAKINGS&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Takings} ASC" alt="{$SortMsg} {$Takings} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=TAKINGS&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Takings} DESC" alt="{$SortMsg} {$Takings} DESC" /></a>
</td>
<td nowrap="nowrap" align="right">{$Expenditures} {$Cashbook_Currency}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=EXPENDITURES&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Expenditures} ASC" alt="{$SortMsg} {$Expenditures} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=EXPENDITURES&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Expenditures} DESC" alt="{$SortMsg} {$Expenditures} DESC" /></a>
</td>
<td nowrap="nowrap" align="right">{$Cash_In_Hand} {$Cashbook_Currency}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=CASH_IN_HAND&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Cash_In_Hand} ASC" alt="{$SortMsg} {$Cash_In_Hand} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=CASH_IN_HAND&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Cash_In_Hand} DESC" alt="{$SortMsg} {$Cash_In_Hand} DESC" /></a>
</td>
<td nowrap="nowrap" align="center">{$DateMsg}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=CASHBOOK_DATE&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$DateMsg} ASC" alt="{$SortMsg} {$DateMsg} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=CASHBOOK_DATE&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$DateMsg} DESC" alt="{$SortMsg} {$DateMsg} DESC" /></a>
</td>
<td nowrap="nowrap" align="left">{$Cashbook_Description}
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/up.png" title="{$SortMsg} {$Cashbook_Description} ASC" alt="{$SortMsg} {$Cashbook_Description} ASC" /></a>
<a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img border="0" src="../images/down.png" title="{$SortMsg} {$Cashbook_Description} DESC" alt="{$SortMsg} {$Cashbook_Description} DESC" /></a>
</td>
...
{foreach from=$CashbookData item=cashbook}
	...
	<td valign="top" align="left"><a name="{$cashbook.CASHBOOKID}" title="{$AllInformation} {$Cashbook_No} {$cashbook.CASHBOOKID}" class="ninfolink" href="../cashbook/info.php?cashbookID={$cashbook.CASHBOOKID}&amp;infoID=30&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}" target="_blank">
