...
<tr><td align="left" class="phprechnung_menu_sub"><a accesskey="1" title="{$Syslog} - {$List}"
href="list.php?{$Session}">{$Syslog}</a></td></tr>
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="2" title="{$Syslog} - {$Help}"
