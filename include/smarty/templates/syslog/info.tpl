...
<tr><td align="center" colspan="2"><h2>{$Syslog} - {$Info}</h2></td></tr>
<tr><td></td></tr>
<tr><td align="center" colspan="2">{$AllInformation} {$EntryNo} {$syslogID}</td></tr>
<tr><td></td></tr>
<tr><td valign="middle" align="right" width="40%">{$Syslog_Created}:</td><td class="dbTxt" valign="middle" align="left" width="60%">{$SYSLOG_CREATED}</td></tr>
<tr><td valign="top" align="right" width="40%">{$Syslog_Description}:</td><td class="dbTxt" valign="top" align="left" width="60%">{$SYSLOG_DESCRIPTION|nl2br}</td></tr>
<tr><td></td></tr>
{* Display back button *}
<tr><td valign="middle" align="center" width="100%" colspan="2">
<form action="list.php?{$Session}#{$syslogID}" method="post">
