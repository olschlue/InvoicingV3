...
<body onload="document.Search.CashbookNo_1.focus();">
...
<tr><td align="left" class="phprechnung_menu_sel"><a accesskey="2" title="{$Cashbook} - {$Search}"
...
<tr><td align="center" colspan="2"><h2>{$Cashbook} - {$Search}</h2></td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td valign="middle" align="right" width="40%">{$CashbookNo}:</td><td valign="top" align="left" width="60%"><input class="form_input" name="CashbookNo_1" size="39" value="" /></td></tr>
<tr><td valign="middle" align="right" width="40%"><b>{$DateMsg} {$DateFrom}</b>:</td><td valign="top" align="left" width="60%"><input class="form_input" name="DateFrom_1" size="39" value="{$cashbookdate}" /></td></tr>
<tr><td valign="middle" align="right" width="40%"><b>{$DateMsg} {$DateTill}</b>:</td><td valign="top" align="left" width="60%"><input class="form_input" name="DateTill_1" size="39" value="{$cashbookdate}" /></td></tr>
<tr><td>&nbsp;</td></tr>
<tr><td valign="middle" align="right" width="40%">{$Takings} {$Currency}</td><td valign="top" align="left" width="60%"><input class="form_input" name="Takings_1" size="39" value="" /></td></tr>
<tr><td valign="middle" align="right" width="40%">{$Expenditures} {$Currency}:</td><td valign="top" align="left" width="60%"><input class="form_input" name="Expenditures_1" size="39" value="" /></td></tr>
<tr><td valign="top" align="right" width="40%">{$Cashbook_Description}:</td><td valign="top" align="left" width="60%"><textarea class="form_textarea" name="Description_1" rows="3" cols="37"></textarea></td></tr>
<tr><td>&nbsp;</td></tr>
