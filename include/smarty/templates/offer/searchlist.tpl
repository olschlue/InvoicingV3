...
<tr><td align="center" colspan="9"><h2>{$Offer} - {$SearchResult}</h2></td></tr>
...
{if $offer.CANCELED neq 1}
	...
	{if $smarty.session.Username and ( $smarty.session.Username eq $Root or $smarty.session.Username eq $offer.CREATEDBY)}
		{if $offer.STATUS neq 3}
			<td valign="top" align="center" width="50"><a href="edit.php?offerID={$offer.OFFERID}&amp;{$AddCurrentPage}infoID=9&amp;Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Searchstring}&amp;{$Session}"><img border="0" src="../images/edit.png" title="{$Editentry}" alt="{$Editentry}" /></a></td>
			<td valign="top" align="center" width="50"><a href="print_pdf.php?myID={$offer.MYID}&amp;offerID={$offer.OFFERID}&amp;Type=Offer&amp;{$Session}" target="_blank"><img border="0" src="../images/print.png" title="{$Print_Offer} - {$Offer_No} {$offer.OFFERID}" alt="{$Print_Offer} - {$Offer_No} {$offer.OFFERID}" /></a></td>
			<td valign="top" align="center" width="50"><a href="../invoice/new.php?myID={$offer.MYID}&amp;offerID={$offer.OFFERID}&amp;tmpID={$offer.OFFERID}&amp;newofferID={$offer.OFFERID}&amp;MethodOfPayment={$offer.METHODOFPAYID}&amp;Note={$offer.NOTE}&amp;messageID={$offer.MESSAGEID}&amp;{$Session}"><img border="0" src="../images/bill.png" title="{$Issue_Invoice}{if $offer.FIRSTNAME} {$offer.FIRSTNAME}{/if}{if $offer.LASTNAME} {$offer.LASTNAME},{/if}{if $offer.COMPANY} {$offer.COMPANY}{/if}" alt="{$Issue_Invoice}{if $offer.FIRSTNAME} {$offer.FIRSTNAME}{/if}{if $offer.LASTNAME} {$offer.LASTNAME},{/if}{if $offer.COMPANY} {$offer.COMPANY}{/if}" /></a></td>
		{else}
