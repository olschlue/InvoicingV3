...
{if $offer.CANCELED neq 1}
	...
	{if $smarty.session.Username and ( $smarty.session.Username eq $Root or $smarty.session.Username eq $offer.CREATEDBY)}
		{if $offer.STATUS neq 3}
			<td valign="top" align="center" width="50"><a href="edit.php?offerID={$offer.OFFERID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Session}"><img border="0" src="../images/edit.png" title="{$Editentry}" alt="{$Editentry}" /></a></td>
