...
//
$query = $db->Execute("SELECT USERID, AES_DECRYPT(FULLNAME,'$pkey') AS FULLNAME, AES_DECRYPT(USERNAME,'$pkey') AS USERNAME, AES_DECRYPT(USERGROUP1,'$pkey') AS USERGROUP1, AES_DECRYPT(USERGROUP2,'$pkey') AS USERGROUP2, LANGUAGE, AES_DECRYPT(PASSWORD,'$pkey') AS PASSWORD, USER_ACTIVE FROM user WHERE USERID=$userID");
