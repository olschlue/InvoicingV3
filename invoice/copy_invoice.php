...
//
$query = $db->Execute("SELECT A.FIRSTNAME, A.LASTNAME, A.COMPANY, A.MYID, DATE_FORMAT(I.ACHIEVED_DATE,'%d.%m.%Y'), I.INVOICEID, I.MYID, DATE_FORMAT(I.INVOICE_DATE,'%d.%m.%Y') AS INVOICE_DATE,
	I.CREATEDBY FROM addressbook AS A, invoice AS I WHERE A.MYID=I.MYID AND I.INVOICEID=$invoiceID");
...
if (!$query)
	...
	foreach($query as $f)
	{
		...
		$InvoiceAchieved = $f['ACHIEVED_DATE'];
