...
else
{
	...
	//
	$query2 = "INSERT INTO invoice (INVOICEID, MYID, INVOICE_DATE, MESSAGEID, MESSAGE_DESC, METHODOFPAYID, METHOD_OF_PAY, METHOD_OF_PAY_DATE, TAX1_TOTAL, TAX2_TOTAL, TAX3_TOTAL, TAX1_DESC, TAX2_DESC, TAX3_DESC, SUBTOTAL1, SUBTOTAL2, SUBTOTAL3, TOTAL_AMOUNT, NOTE, PAID, SUM_PAID, CANCELED, CREATEDBY, MODIFIEDBY, USERGROUP1, USERGROUP2, CREATED, MODIFIED, ACHIEVED_DATE)";
	$query2 .= "VALUES (NULL, '$MYID', CURDATE(), '$MESSAGEID', '$MESSAGE_DESC', '$METHODOFPAYID', '$METHOD_OF_PAY', '', '$TAX1', '$TAX2', '$TAX3', '$TAX1_DESC', '$TAX2_DESC', '$TAX3_DESC', '$SUBTOTAL1', '$SUBTOTAL2', '$SUBTOTAL3', '$TOTAL_AMOUNT', '$NOTE', '2', '', '2', '$_SESSION[Username]', '$_SESSION[Username]', '$_SESSION[Usergroup1]', '$_SESSION[Usergroup2]', '$CurrentDateTime', '$CurrentDateTime', CURDATE())";
